...
class UserLevel2Add extends UserLevel2
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        } elseif ((int)$this->User_Level_ID->CurrentValue == 0 && !SameText($this->Name->CurrentValue, "Default")) {
            $this->setFailureMessage($Language->phrase("UserLevelDefaultName"));
        } elseif ((int)$this->User_Level_ID->CurrentValue == -1 && !SameText($this->Name->CurrentValue, "Administrator")) {
            $this->setFailureMessage($Language->phrase("UserLevelAdministratorName"));
        } elseif ((int)$this->User_Level_ID->CurrentValue == -2 && !SameText($this->Name->CurrentValue, "Anonymous")) {
            $this->setFailureMessage($Language->phrase("UserLevelAnonymousName"));
        } elseif ((int)$this->User_Level_ID->CurrentValue > 0 && in_array(strtolower(trim($this->Name->CurrentValue)), ["anonymous", "administrator", "default"])) {
