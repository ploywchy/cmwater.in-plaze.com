...
class Category extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Category_ID->Sortable = false; // Allow sort
        ...
        // Image
        $this->Image = new DbField('category', 'category', 'x_Image', 'Image', '`Image`', '`Image`', 200, 255, -1, true, '`Image`', false, false, false, 'IMAGE', 'FILE');
        ...
        // Priority
        $this->Priority = new DbField('category', 'category', 'x_Priority', 'Priority', '`Priority`', '`Priority`', 3, 5, -1, false, '`Priority`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Description
        $this->Description = new DbField('category', 'category', 'x_Description', 'Description', '`Description`', '`Description`', 201, 65535, -1, false, '`Description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("product")->loadRs("`Category_ID` = " . QuotedValue($rsold['Category_ID'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("product")->loadRs("`Category_ID` = " . QuotedValue($rs['Category_ID'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->Category_ID->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->Category_ID->CurrentValue);
        } else {
