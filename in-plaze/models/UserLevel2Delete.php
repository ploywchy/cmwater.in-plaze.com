...
class UserLevel2Delete extends UserLevel2
{
    ...
    public function renderRow()
    {
        ...
        // Name
        $this->Name->CellCssStyle = "min-width: 100%;";
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                if ($x_User_Level_ID != null) {
                    $conn->executeUpdate("DELETE FROM " . Config("USER_LEVEL_PRIV_TABLE") . " WHERE " . Config("USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD") . " = " . $x_User_Level_ID); // Delete user rights as well
                }
            }
        }
        if (!$deleteRows) {
