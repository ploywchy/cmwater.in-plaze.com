...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Grid->_New->isInvalidClass() ?>" data-table="product" data-field="x__New" name="x<?= $Grid->RowIndex ?>__New[]" id="x<?= $Grid->RowIndex ?>__New_961346" value="1"<?= ConvertToBool($Grid->_New->CurrentValue) ? " checked" : "" ?><?= $Grid->_New->editAttributes() ?>>
    <label class="custom-control-label" for="x<?= $Grid->RowIndex ?>__New_961346"></label>
</div>
...
<span id="el<?= $Grid->RowCount ?>_product__New" class="form-group">
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Grid->_New->isInvalidClass() ?>" data-table="product" data-field="x__New" name="x<?= $Grid->RowIndex ?>__New[]" id="x<?= $Grid->RowIndex ?>__New_966947" value="1"<?= ConvertToBool($Grid->_New->CurrentValue) ? " checked" : "" ?><?= $Grid->_New->editAttributes() ?>>
    <label class="custom-control-label" for="x<?= $Grid->RowIndex ?>__New_966947"></label>
</div>
<div class="invalid-feedback"><?= $Grid->_New->getErrorMessage() ?></div>
</span>
<?php } ?>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Grid->_New->isInvalidClass() ?>" data-table="product" data-field="x__New" name="x<?= $Grid->RowIndex ?>__New[]" id="x<?= $Grid->RowIndex ?>__New_712824" value="1"<?= ConvertToBool($Grid->_New->CurrentValue) ? " checked" : "" ?><?= $Grid->_New->editAttributes() ?>>
    <label class="custom-control-label" for="x<?= $Grid->RowIndex ?>__New_712824"></label>
</div>
<div class="invalid-feedback"><?= $Grid->_New->getErrorMessage() ?></div>
</span>
<?php } else { ?>
