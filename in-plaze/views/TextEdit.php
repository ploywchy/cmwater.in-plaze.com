...
loadjs.ready("head", function () {
    ...
    ftextedit = currentForm = new ew.Form("ftextedit", "edit");
    ...
    // Form_CustomValidate
    ftextedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftextedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftextedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftextedit" id="ftextedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="text" data-field="x_Content_ID" data-hidden="1" name="x_Content_ID" id="x_Content_ID" value="<?= HtmlEncode($Page->Content_ID->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
