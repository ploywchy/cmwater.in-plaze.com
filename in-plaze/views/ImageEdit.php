...
loadjs.ready("head", function () {
    ...
    fimageedit = currentForm = new ew.Form("fimageedit", "edit");
    ...
    // Form_CustomValidate
    fimageedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fimageedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fimageedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fimageedit" id="fimageedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" name="fa_x_Value" id= "fa_x_Value" value="<?= (Post("fa_x_Value") == "0") ? "0" : "1" ?>">
...
<?php } ?>
    ...
    <input type="hidden" data-table="image" data-field="x_Image_ID" data-hidden="1" name="x_Image_ID" id="x_Image_ID" value="<?= HtmlEncode($Page->Image_ID->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
