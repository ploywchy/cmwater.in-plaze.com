 ...
 * Page class
 */
class ImageDelete extends Image
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImageDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ImageList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ImageList"); // Return to list
                return;
            }
        }
