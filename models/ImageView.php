    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Image_ID") ?? Route("Image_ID")) !== null) {
                ...
                $returnUrl = "ImageList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ImageList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ImageList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
