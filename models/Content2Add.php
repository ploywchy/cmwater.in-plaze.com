 ...
 * Page class
 */
class Content2Add extends Content2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Content2Add";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "Content2View") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->Content_ID->OldValue = $this->Content_ID->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['Content_ID'] = $this->Content_ID->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Name
        $this->Name->CurrentValue = ip_get_content_search();
