...
$sideMenu->addMenuItem(40, "mci_Back_to_web_page", $MenuLanguage->MenuPhrase("40", "MenuText"), $MenuRelativePath . "index.html", -1, "", true, false, true, "fa-arrow-circle-left", "", false);
...
$sideMenu->addMenuItem(58, "mi_content2", $MenuLanguage->MenuPhrase("58", "MenuText"), $MenuRelativePath . "Content2List", -1, "", AllowListMenu('{inplaze}content'), false, false, "fa-align-left", "", false);
...
$sideMenu->addMenuItem(59, "mi_blog", $MenuLanguage->MenuPhrase("59", "MenuText"), $MenuRelativePath . "BlogList", -1, "", AllowListMenu('{inplaze}blog'), false, false, "fa fa-newspaper-o", "", false);
