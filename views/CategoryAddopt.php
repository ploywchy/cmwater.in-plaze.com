...
<?php if ($Page->Image->Visible) { // Image ?>
    <div class="form-group row">
        <label class="col-sm-3 col-form-label ew-label"><?= $Page->Image->caption() ?><?= $Page->Image->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="col-sm-9">
<div id="fd_x_Image">
...
<?php if ($Page->Name->Visible) { // Name ?>
    <div class="form-group row">
        <label class="col-sm-3 col-form-label ew-label" for="x_Name"><?= $Page->Name->caption() ?><?= $Page->Name->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="col-sm-9">
