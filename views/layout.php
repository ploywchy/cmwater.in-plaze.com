...
<link rel="stylesheet" type="text/css" href="<?= $basePath ?><?= CssFile(Config("PDF_STYLESHEET_FILENAME")) ?>">
<?php } ?>
<link rel="stylesheet" type="text/css" href="<?= $basePath ?>css/style-2020.css">
...
<link href="https://fonts.googleapis.com/css?family=Bai Jamjuree:100,100italic,300,300italic,400,400italic,700,700italic,900,900italic&display=swap" rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Lato:900i&display=swap" rel="stylesheet">
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-47272895-5"></script>
<!-- Navbar -->
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none" href="#"  onclick="return false;">
                <span class="brand-text">In-plaze</span>
            </a>
        </ul>
        <!-- Right navbar links -->
