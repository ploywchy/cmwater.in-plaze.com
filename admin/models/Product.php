...
class Product extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Product_ID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Product_ID->Param, "CustomMsg");
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "category" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_Category_ID", $this->Category_ID->CurrentValue ?? $this->Category_ID->getSessionValue());
        }
        return $url;
    }
