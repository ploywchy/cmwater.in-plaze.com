...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "password" => "", "dbname" => "inplaze"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "Bfo43rDKuXW558ld", // API Secret Key
        ...
        "NOT_BEFORE_TIME" => 10, // API access time before login
