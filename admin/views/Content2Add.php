...
loadjs.ready("head", function () {
    ...
    fcontent2add = currentForm = new ew.Form("fcontent2add", "add");
    ...
    // Validate form
    fcontent2add.validate = function () {
    ...
    // Form_CustomValidate
    fcontent2add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcontent2add.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcontent2add");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcontent2add" id="fcontent2add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fcontent2add", "editor"], function() {
	ew.createEditor("fcontent2add", "x_Value", 35, 4, <?= $Page->Value->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
