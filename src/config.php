...
$LANGUAGES = [["en","","english.xml"],["th","","thai.xml"]];
...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'rA9l7E281Fyq0ALI', // Random key for encryption
    ...
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-danger navbar-dark border-bottom",
    ...
    "SESSION_TIMEOUT_COUNTDOWN" => 120, // Session timeout count down interval (seconds)
    ...
    "ADMIN_PASSWORD" => "test-2011", // Administrator password
    ...
    "USER_LEVEL_PRIV_TABLE" => "`user_level_permission`",
    ...
    "UPLOAD_THUMBNAIL_WIDTH" => 100, // Temporary thumbnail max width
    "UPLOAD_THUMBNAIL_HEIGHT" => 100, // Temporary thumbnail max height
    "UPLOAD_ALLOWED_FILE_EXT" => "webm,mp4,gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip", // Allowed file extensions
